...
.controller('DisplayExpense', function ($scope, $http,$location,ionicToast,$ionicPopup,$ionicLoading) {
		...
		var path=window.localStorage['path'];
	    //var nUserId=window.localStorage['UserId'];
	    var path ="http://localhost:43871/WebServices/Expense.asmx/"; //static path
	    var UserId=1;
		...
		$http({
					method: 'POST',
					url: path + 'SelectAllDisplayExpense',
					headers: {'Content-Type': 'application/x-www-form-urlencoded; charset=UTF-8'},
					data: { nUserId : UserId},
					transformRequest: function (obj) {
                    var str = [];
